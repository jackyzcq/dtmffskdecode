...
struct simpleaudio_backend {
	...
	ssize_t
	(*simpleaudio1_read)( simpleaudio *sa, void *buf, unsigned int nframes );

	ssize_t
	(*simpleaudio1_write)( simpleaudio *sa, void *buf, unsigned int nframes );

	void
	(*simpleaudio1_close)( simpleaudio *sa );
};
